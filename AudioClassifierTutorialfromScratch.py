...
# Function to remove extra dimension from audio
...
# Keep full validation set (no sharding)
...
for batch_audio, batch_labels in train_ds.take(1):
    print("\nBatch Shape (Audio):", batch_audio.shape)
...
for i in range(n):
    ...
    plt.title(label_names[batch_labels[i]])
...
# Apply cache, shuffle, and prefetch optimizations with .repeat() for continuous epochs
